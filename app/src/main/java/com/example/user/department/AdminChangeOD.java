...
public class AdminChangeOD extends AppCompatActivity implements Spinner.OnItemSelectedListener{

    // Server user register url
    public static String URL_FETCHCT = "http://nikesh.esy.es/php_files/ChangeCT.php";

    // url to get all products list
    private static String URL_UPDATECT = "http://nikesh.esy.es/php_files/UpdateODIncharge.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_change_od);
        ...
        spiOD =(Spinner)findViewById(R.id.spiOD);
        spiOD.setOnItemSelectedListener(this);

        btnChangeOD =(Button)findViewById(R.id.btnAdminChangeOD);
        ...
        btnChangeOD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (selectedCounsellor.matches(""))
                {
                    Toast.makeText(AdminChangeOD.this,"Select the Faculty",Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    private void getStudents(JSONArray j){
        ...
        spiOD.setAdapter(new ArrayAdapter<String>(AdminChangeOD.this, android.R.layout.simple_spinner_dropdown_item, students));
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success==1) {
                        ...
                        Toast.makeText(AdminChangeOD.this,"OD-Incharge updated",Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(AdminChangeOD.this,AdminDashboard.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(AdminChangeOD.this,"Oops! Problem occurred",Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
